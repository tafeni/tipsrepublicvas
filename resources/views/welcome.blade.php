        ...
        * {
        ...
        .sports-hero::before {
            ...
            background: 
                ...
                url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><defs><pattern id="sportsPattern" width="200" height="200" patternUnits="userSpaceOnUse"><g opacity="0.25"><circle cx="30" cy="30" r="18" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="2"/><path d="M12 30 L48 30 M30 12 L30 48" stroke="rgba(255,255,255,0.4)" stroke-width="1.5"/><circle cx="170" cy="50" r="15" fill="none" stroke="rgba(255,255,255,0.35)" stroke-width="2"/><path d="M155 50 Q170 35 185 50 Q170 65 155 50" fill="none" stroke="rgba(255,255,255,0.35)" stroke-width="1.5"/><circle cx="80" cy="120" r="12" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="1.8"/><path d="M68 120 L92 120 M80 108 L80 132 M72 112 L88 128 M88 112 L72 128" stroke="rgba(255,255,255,0.3)" stroke-width="1.2"/><ellipse cx="150" cy="150" rx="20" ry="12" fill="none" stroke="rgba(255,255,255,0.25)" stroke-width="1.5"/><path d="M130 150 Q150 138 170 150" stroke="rgba(255,255,255,0.25)" stroke-width="1.2"/><polygon points="40,170 60,165 60,175 40,180 20,175 20,165" fill="none" stroke="rgba(255,255,255,0.2)" stroke-width="1.5"/><path d="M25 167 L55 173 M25 173 L55 167" stroke="rgba(255,255,255,0.2)" stroke-width="1"/><circle cx="120" cy="40" r="10" fill="none" stroke="rgba(255,255,255,0.28)" stroke-width="1.5"/><path d="M110 40 Q120 30 130 40 Q120 50 110 40 M120 30 L120 50" stroke="rgba(255,255,255,0.28)" stroke-width="1.2"/><polygon points="60,80 75,85 75,95 60,100 45,95 45,85" fill="none" stroke="rgba(255,255,255,0.22)" stroke-width="1.5"/><path d="M50 87 L70 93 M50 93 L70 87" stroke="rgba(255,255,255,0.22)" stroke-width="1"/><circle cx="180" cy="120" r="14" fill="none" stroke="rgba(255,255,255,0.32)" stroke-width="2"/><path d="M166 120 Q180 106 194 120 Q180 134 166 120" stroke="rgba(255,255,255,0.32)" stroke-width="1.5"/></g></pattern></defs><rect width="200" height="200" fill="url(%23sportsPattern)"/></svg>');
            opacity: 0.9;
        }
